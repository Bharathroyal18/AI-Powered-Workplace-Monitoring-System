...
# Load fairness-improved model
recognizer = cv2.face.LBPHFaceRecognizer_create()
recognizer.read("trainer/fairness_trainer.yml")

employees = ["101", "103"]

print()
print("Fairness-Improved Model Evaluation")
print("----------------------------------")
...
if len(accuracy_list) > 0:
    ...
    print(
        "Worst User Accuracy:",
        round(worst_accuracy, 2),
        "%"
    )

    print(
        "Consistency Gap:",
        round(consistency_gap, 2),
        "percentage points"
    )